const HeroSection = () => {
  return (
    <section id="HeroSection" className="bg-black dark:bg-black">
      <div className="py-8 px-4 mx-auto max-w-screen-xl text-center lg:py-16 lg:px-12">
        ...
        >
          ...
          <span className="text-sm font-medium">
            Sign-up for priority access once released 🎯
          </span>
          <svg
        ...
        <h1 className="mb-4 text-4xl font-extrabold tracking-tight leading-none text-white md:text-5xl lg:text-6xl dark:text-white">
          Unleash the power of <span classNameName="text-primary-600">AI</span> into
          Fitness 🤖
        </h1>
        ...
        <div className="px-4 mx-auto text-center md:max-w-screen-md lg:max-w-screen-lg lg:px-36">
          <span className="font-semibold text-gray-400 uppercase">
            Share Your Journey With Others (Coming soon)
          </span>
          <div className="flex flex-wrap ml-10 justify-center items-center mt-8 text-gray-500">
            <a
              href="/"
